<?php
  ...
  $codigo = $_GET['codigo'];
    ...
    $habitaciones = "SELECT Cantidad_Personas, CostoHabitacion, Detalle, NombreHabitacion, Piso FROM habitaciones WHERE ID_Habitacion = " . $codigo;
    ...
    while($row = mysqli_fetch_array($listaHabitaciones)) 
    {
      ...
      $detalle = $row['Detalle'];
      $CostoHabitacion = $row['CostoHabitacion'];
        ...
        <form action="" method="post">
                <div class="row" style="margin-bottom: 4%;">
                  <div class="col-3">
                     ...
                     <input type="number" id="cantidadPersonas" name="cantidadPersonas" value="<?php echo $cantidadPersonas ?>" maxlength="10"></input>	
                  </div>

                  <div class="col-3">
                     Costo-Habitación:<br/>  
                     <input type="number" id="CostoHabitacion" name="CostoHabitacion"  value="<?php echo $CostoHabitacion ?>" maxlength="10"></input>	
                  </div>


                  <div class="col-3">
                     Detalle:<br/>  
                     <input type="text" id="detalle" name="detalle" value="<?php echo $detalle ?>" maxlength="20"></input>	
                  </div>


                  <div class="col-3">
                     Nombre Habitación:<br/>  
                     <input type="text" id="nombreHabitacion" name="nombreHabitacion" value="<?php echo $nombreHabitacion ?>" maxlength="20"></input>	
                  </div>

                  <div class="col-3">
                     Piso:<br/>  
                     <input type="number" id="piso" name="piso" value="<?php echo $piso ?>" maxlength="10"></input>	
                  </div>

                  <div class="col-12">
                  <input type="submit" id="btnActualizar" value="Actualizar" name="btnActualizar"></input>
                  </div>
</br>

                  <div class="col-12">
                  <input type="submit" id="btnEliminar" value="Eliminar" name="btnEliminar"></input>
                  </div>
</br>
                  </div>
          </form>
